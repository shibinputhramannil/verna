  ...
  return (
    <div className="creoture-mode">
      ...
      <header className="reference-header">
        <div className="ref-brand"><a href="#home">VERNA</a><span className="brand-caption">CONSULTING</span></div>
      ...
      <main>
        <section id="home" className="ref-hero ref-section">
          <div className="ref-container hero-ref-grid">
            ...
            <div className="hero-title-wrap scroll-reveal"><p className="display-eyebrow">BUILT FOR CONSEQUENTIA‍L WORK</p><h1>VERNA</h1></div>
        ...
        <section id="expertise" className="ref-section services-ref-section">
          <div className="ref-container"><p className="section-code">/ 02 — EXPERTISE</p><div className="section-title-row scroll-reveal"><h2>SERVICES</h2><p>Five ways we help ambitious teams move from uncertainty to outcomes.</p></div><div className="service-list">{services.map(([number, title, copy]) => <a className="service-row scroll-reveal" href="#contact" key={number}><span className="service-num">{number}</span><h3>{title}</h3><span className="service-copy">{copy}</span><ArrowUpRight className="service-arrow" size={20} /></a>)}</div></div>
        </section>
        ...
        <section id="about" className="ref-section about-ref-section"><div className="ref-container"><p className="section-code">/ 05 — THE PEOPLE</p><div className="section-title-row scroll-reveal"><h2>THE<br /><span className="purple-text">TEAM</span></h2><p>Small enough to care deeply. Experienced enough to know what it takes.</p></div><div className="team-list">{team.map(([initials, name, role, copy, image], index) => <article className="team-row scroll-reveal" key={name}><div className={`team-avatar team-avatar-${index}`}>{image ? <img src={image} alt={name} className="team-avatar-img" /> : <><span>{initials}</span><div /></>}</div><div><p className="team-role">{role}</p><h3>{name}</h3><p className="team-copy">{copy}</p></div><ArrowUpRight size={20} /></article>)}</div></div></section>
