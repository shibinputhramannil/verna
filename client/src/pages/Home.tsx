      ...
      <main>
        ...
        <section id="approach" className="ref-section approach-ref-section">
          <div className="ref-container">
            ...
            <div className="approach-layout"><div className="approach-art"><img className="approach-reference-image" src="/manus-storage/pasted_file_N0LHtc_image_ad556625.png" alt="Orbital system diagram showing decision, system, and momentum around a central node." /><div className="art-orbit art-orbit-a" /><div className="art-orbit art-orbit-b" /><div className="art-core">N<span>↗</span></div><div className="art-label art-label-a">DECISION</div><div className="art-label art-label-b">SYSTEM</div><div className="art-label art-label-c">MOMENTUM</div></div><div className="approach-copy"><p className="quote-large">You may not notice it.<br /><span>But you&apos;ll feel it.</span></p><p className="muted-copy">The right strategy creates a different kind of energy: less explaining, more deciding. Less motion, more movement.</p><div className="est-line">VERNA — EST. 2016</div></div></div>
          </div>
        </section>
